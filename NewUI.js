...
createSetting('DynamicPrestige', 'Dynamic Prestige', 'Skip getting prestiges at first, and Gradually work up to the desired Prestige setting you have set. Runs with Dagger to save a significant amount of time until we need better gear, then start increasing the prestige setting near the end of the run (as dicatated by your challenge\'s last zone number or your custom autoportal zone number). Starts getting a few prestiges 20 zones away from max, then really attaining the desired Prestige at 10 zones away from max, Finally reaching the desired prestige by the last zone. (And also goes for 9 mapbonus on the last zone.) CAUTION: EXPERIMENTAL, please come to Discord chat if you have problems.', 'boolean', null, null, 'genbtcadvancedSettings');
...
amakyreBtn.id='amakyreadvancedSettingsBTN';
advHeader.appendChild(amakyreBtn);
//
var amakyreadv = document.createElement("DIV");
amakyreadv.id = 'amakyreadvancedSettings';
amakyreadv.style.display = 'none';
document.getElementById("autoSettings").appendChild(amakyreadv);
