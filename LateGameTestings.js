...
function autoMap() {
    ...
    if (game.global.mapsUnlocked) {
        ...
        if ((game.global.mapBonus < 1 && game.global.lastClearedCell > 70 && (game.global.world == 9125 || game.global.world == 9140 || game.global.world == 9155 || game.global.world == 9170 || game.global.world == 9185)) ||
    ...
    //    (game.global.mapBonus <= 8 && game.global.world == autoTrimpSettings.VoidMaps.value) ||
        ...
        for (var map in game.global.mapsOwnedArray) {
            ...
            if (theMap.noRecycle && getPageSetting('RunUniqueMaps')) {
                ...
                if (theMap.name == 'Bionic Wonderland VII' && game.global.lastClearedMapCell > 1 && game.global.lastClearedMapCell < 8 && game.global.world >= 215) {
                DoBionic_VII = false;
                }
