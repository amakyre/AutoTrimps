    ...
    if (unlockedHousing.length) {
        ...
        for (var best in keysSorted) {
            ...
            if (game.buildings[keysSorted[best]].owned < max || max == -1) {
                ...
                if ((WarpstationWall == true && bestBuilding == "Warpstation") || (bestBuilding == "Warpstation" && game.buildings.Warpstation.owned == 241))
...
//        (game.global.mapBonus <= 1 && game.global.world >= 212 && game.global.world < 220) ||
        ...
        (game.global.mapBonus <= 8 && (game.global.world == 9230  && game.global.lastClearedCell > 93)) ||
...
//        (game.global.world >= 22// && game.global.world <= 230 && game.global.mapBonus <= 2) ||
        (game.global.world == 220 && game.global.mapBonus <= 3) ||
//        (game.global.world >= 210 && game.global.lastClearedCell > 93 && ((new Date().getTime() - game.global.mapStarted > 8000 && game.global.mapsActive) || game.global.mapBonus <= 9 )) ||
        ((game.global.world == 235 || game.global.world == 200) && game.global.lastClearedCell > 70 && ((new Date().getTime() - game.global.zoneStarted) / 1000 / 60) < 3) ||
        ((game.global.world >= 225 && game.global.world < 235 ) && game.global.mapBonus < 2) ||
